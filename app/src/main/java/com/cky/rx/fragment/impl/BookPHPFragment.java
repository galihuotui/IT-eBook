 ...
 */
public class BookPHPFragment extends BaseFragment implements  SwipeRefreshLayout.OnRefreshListener, View.OnClickListener{

    private static final String TAG = "BookPHPFragment";
    private static final String QUERY_KEY = "PHP";
