 ...
 */
public class BookPythonFragment extends BaseFragment implements  SwipeRefreshLayout.OnRefreshListener, View.OnClickListener{

    private static final String TAG = "BookPythonFragment";
    private static final String QUERY_KEY = "Python";
