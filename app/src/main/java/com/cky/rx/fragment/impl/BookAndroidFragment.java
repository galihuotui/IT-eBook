 ...
 */
public class BookAndroidFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener{
    ...
    */
    ...
    public void onRefresh() {
        Log.d(TAG, String.valueOf(adapter.getItems() == null) );
        if (adapter.getItems() != null) {
            adapter.setItems(null);
            page_index = 1;
        }
