 ...
 */
public class BookJavaScriptFragment extends BaseFragment implements  SwipeRefreshLayout.OnRefreshListener, View.OnClickListener{

    private static final String TAG = "BookJavascriptFragment";
    private static final String QUERY_KEY = "Javascript";
